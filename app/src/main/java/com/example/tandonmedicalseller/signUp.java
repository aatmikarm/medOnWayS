...
public class signUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken("157671413790-a148v3i9ngrfobso9ud9lrh8f58450tg.apps.googlesellercontent.com")
                .requestEmail()
                .build();
                ...
                .addOnCompleteListener(new OnCompleteListener<String>() {
                    ...
                    public void onComplete(@NonNull Task<String> task) {
                        if (task.isSuccessful()) {
                            sellerToken = Objects.requireNonNull(task.getResult().toString());
                        }
                    }
                });
        ...
        signup_progressBar = (ProgressBar) findViewById(R.id.signIn_progressBar);
                ...
                firebaseAuth.createUserWithEmailAndPassword(signupEmail, signupPassword).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            mDb.collection("sellers").document(uid).set(seller);
            ...
            firebaseAuth.signInWithCredential(authCredential).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                ...
                public void onSuccess(AuthResult authResult) {
                    ...
                    if (authResult.getAdditionalUserInfo().isNewUser()) {
                        ...
                        seller.put("phone", "");
                        seller.put("bio", "I am a seller");
                        seller.put("imageUrl", imageUrl);
                        seller.put("sellerToken", sellerToken);
                        seller.put("type", "seller");
                        seller.put("CurrentDateAndTime", CurrentDateAndTime);
